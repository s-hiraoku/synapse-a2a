...
[![Tests](https://img.shields.io/badge/tests-1932%20passed-brightgreen.svg)](#pruebas)
...
| ID completo | `synapse-claude-8100` | Coincidir ID exacto del agente |
...
|--------|-------|-------------|
| `--from` | `-f` | ID del agente remitente (opcional; auto-detectado) |
