...
- [skills](../README.md#skills) — skill catalog in the main README.
- [references.md](../guides/references.md) — CLI / skill reference.
- `feedback_skill_management_gh_cli.md` in agent memory — project
  decision record for this migration.
