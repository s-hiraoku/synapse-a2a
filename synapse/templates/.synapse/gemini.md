...
python3 synapse/tools/a2a.py send --target claude --response "What is the best practice for error handling in Python?"
...
python3 synapse/tools/a2a.py send --target claude --no-response "Research React best practices"
