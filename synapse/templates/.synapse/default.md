...
- `@gemini message` - Send with flow setting (a2a.flow in settings.json)
- `@gemini --response message` - Wait for response (roundtrip)
- `@gemini --no-response message` - Fire and forget (oneway)
