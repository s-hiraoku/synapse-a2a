...
| **MCP Bootstrap** | `synapse mcp serve` exposes bootstrap resources (instructions, settings, agent card) via the Model Context Protocol over stdio. Lets MCP-capable agents pull Synapse context without PTY injection. See [MCP Bootstrap Design](docs/design/mcp-bootstrap.md) |
